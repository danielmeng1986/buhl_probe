...
export class MyOffice {
  ...
  readonly prevCardImagePaths: ResponsiveImagePaths = {
    mobile: {
      ...
      srcset: '/assets/pngs/320-390/Bild 1.png 1x, /assets/pngs/320-390/Bild 1@2x.png 2x'
    },
    tablet: {
      src: '/assets/pngs/768/Bild 1.png',
      srcset: '/assets/pngs/768/Bild 1.png 1x, /assets/pngs/768/Bild  1@2x.png 2x'
    },
    desktop: {
      src: '/assets/pngs/1200/Bild 1.png',
      srcset: '/assets/pngs/1200/Bild 1.png 1x, /assets/pngs/1200/Bild  1@2x.png 2x'
    },
    desktopXl: {
      src: '/assets/pngs/1200/Bild 1.png',
      srcset: '/assets/pngs/1200/Bild 1.png 1x, /assets/pngs/1200/Bild  1@2x.png 2x'
